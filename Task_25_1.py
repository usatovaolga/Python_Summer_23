...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        layout = QVBoxLayout()
        #layout = QHBoxLayout()#расположение виджетов по горизонтали

        widget0 = QLabel("Введите выражение") # Label "Введите число"
        font = widget0.font()
        font.setPointSize(10)
        widget0.setFont(font)
        widget0.setStyleSheet('background: rgb(255,255,0);')
        ...
        widgets = [widget0, self.widget2, button, self.label_result, self.qte]  ################################
        for w in widgets:
            layout.addWidget(w)
    ...
    def return_pressed(self):
        ...
        self.the_button_was_clicked()#-- по действию ентер результат
    ...
    def the_button_was_clicked(self):
        self.text = self.widget2.text() #запись текста в момент нажатия результат
        print("Clicked!")
